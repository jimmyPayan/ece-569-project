...
int main(int argc, char* argv[]){
  cout << "ECE569 CUDA Implementation: 16x16 Threads/Block" << endl << "Shared Memory with Histogram." << endl << "Replaced 16 global memory reads with local variable accesses." << endl;
